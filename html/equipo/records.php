...
<div class="container-fluid">
	...
	<div class='row'>
		...
		<h4><a href='/cotizacion/html/equipo/new_factura.php' alt="Crear Factura"><i class="fas fa-file"></i></a>&nbsp;&nbsp;&nbsp;<a href='/cotizacion/html/equipo/new.php' alt="Nuevo Equipo"><i class="fas fa-plus-circle"></i></a></h4>
