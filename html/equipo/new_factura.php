...
<?php
	...
	include '/var/www/html/cotizacion/html/php/views/ClienteView.php';
...
//$clave_sat = $_GET['clave_sat'];
			echo "<h3>Folio:".$folio."</h3>";
			echo "<form action='/cotizacion/html/php/managers/EquipoFacturaManagerView.php?mode=new&folio=$folio' method='post'>";
			...
			$cliente->newForm();
			echo "<button type='submit' class='btn btn-secondary'>Generar</button><br><br>";
			echo "</div>";
			...
			$equipo = new EquipoView();
			$equipo->printRecordsFactura('default');
