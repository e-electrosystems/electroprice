...
<?php
	...
	include '/var/www/html/cotizacion/html/php/views/ProyectoView.php';
...
//$clave_sat = $_GET['clave_sat'];
			...
			echo "<form action='/cotizacion/html/php/managers/ProyectoManagerView.php?mode=new' method='post'>";
			echo "<div class='row'>";
