...
<div class="container-fluid">
	...
	<?php
		...
		echo "<div class='row'>
			...
			echo "<form action='/cotizacion/html/php/managers/HerramientaManagerView.php?mode=search' method='post'>";
	...
	<div class='row'>
		...
		echo "<div class='col-sm-6 text-right'>";
		echo "<form action='/cotizacion/html/php/managers/HerramientaManagerView.php?mode=new' method='post'>";
    	echo "<input name='codigo_barra' type='text' placeholder='Codigo de Barra'>";
    	echo "<input name='tool_name' type='text' placeholder='Nombre'>";
    	echo "<button type='submit' class='btn btn-secondary'>Agregar</button>";
		echo "</form>";
...
<?php
	include '/var/www/html/cotizacion/html/php/views/HerramientaView.php';	
	/*include 'php/views/ProveedorView.php';
	include 'php/views/ClienteView.php';
	include 'php/views/BodegaView.php';	
